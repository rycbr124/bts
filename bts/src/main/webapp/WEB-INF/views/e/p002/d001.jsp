...
<body>
	<div id="container">
		...
		<form name="form-horizontal" role="form" name="frmWrite" action="${contextPath }/accompany2/accInsert" method="post">
			<div id="form-group">
			...
			<div id="form-group">
				<div class="form-control" id="tag-list">
					<input type="text" placeholder="태그"><span></span>
				</div>
			</div>
			<div id="form-group">
				<textarea id="editor" name="editor"></textarea>
			</div>
			<input type="hidden" name="imageList"> <input type="hidden" name="tagList">
