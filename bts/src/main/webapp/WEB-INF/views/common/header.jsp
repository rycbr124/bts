...
.header_logo img:hover{width:130px; height:70px;position:absolute;left:0;top:20px; content:url(/bts/resources/image/logo/검정/logo_black.png);}

/*MENU*/
.menu_container {width: 100%;position: relative;font-size:0;line-height: 1;text-align: center;z-index: 1;}
#menu {margin-top:0;text-align:center; -webkit-transition: all 0.3s; transition:all 300ms;}
#menu:after {content: '';display: table;clear: both;}
#menu a {display: block;line-height: 1.7;text-decoration:none;}

/*1depth*/
#menu > li { padding:24px 24px; display: inline-block;vertical-align: top;position: relative; cursor:pointer; margin-top:10px;}
...
/*MEMBER*/
.member_menu{position:absolute;right:70px;top:40px;}
